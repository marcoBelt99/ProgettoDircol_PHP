...
<body>
    ...
    ?>
        ...
        ?>
            <div class="container divMessaggio" id="divAggiornaQualifica_Dipendenti">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
                    <strong>Attenzione! </strong> Devi inserire il codice fiscale del dipendente.
    ...
    ?>
        <div class="container divMessaggio">
            ...
            <div class="alert alert-warning alert-dismissible">
                ...
                <strong>Attenzione! </strong> Compila tutti i campi.
                <br>
                <strong>Ricorda: </strong> Deve esistere almeno un punto vendita.
            </div>
        </div>
        <!-- <p class="text-warning">!!</p> -->
    <?php
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>#formAggiornaVendite" id="formAggiornaVendite" class="formOperazioniDML">
                ...
                <div class="form-group">
                    ...
                    <p>
                        ...
                        <select name="ID_Vendite" id="ID_Vendite" onchange="hideDiv('divAggiornaID_Vendite',this); showDiv('divAggiornaID_Vendite',this)">
                            <option>---</option>
                            <?php
                    ...
                    <p>
                        ...
                        <input type="date" name="DataVendita" id="DataVendita_Vendite" onchange="hideDiv('divAggiornaDataVendita_Vendite',this); showDiv('divAggiornaDataVendita_Vendite',this)" />
                    </p>
                    <p>
                        <label for="Prezzo Vendita">Prezzo di vendita:&nbsp; </label>
                        <input type="number" step="0.01" name="PrezzoVendita" id="PrezzoVendita_Vendite" onchange="hideDiv('divAggiornaPrezzoVendita_Vendite',this); showDiv('divAggiornaPrezzoVendita_Vendite',this)"></input>
                    </p>

                    <!-- SELEZIONO LA MATRICOLA DA INSERIRE (in ordine) -->
                    <p>
                        <label for="Matricola">Matricola agente di vendita:&nbsp; </label>
                        <select name="Matricola" id="Matricola_Vendite" onchange="hideDiv('divAggiornaMatricola_Vendite',this); showDiv('divAggiornaMatricola_Vendite',this)">
                            <option>---</option>
                            <?php
                            // Comando SQL. ( Ricorda: il .= è stato deprecato )
                    ...
                    <p>
                        ...
                        <select name="IdCapo" id="IDCapo_Vendite" onchange="hideDiv('divAggiornaIDCapo_Vendite',this); showDiv('divAggiornaIDCapo_Vendite',this)">
                            <option>---</option>
                            <?php
                            // Comando SQL. ( Ricorda: il .= è stato deprecato )
    ...
    ?>
            <div class="container divMessaggio" id="divAggiornaID_Vendite">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
                    <strong>Attenzione! </strong> Devi inserire l'ID della vendita da aggiornare.
                </div>
            </div>
        ...
        ?>
            <div class="container divMessaggio" id="divAggiornaPrezzoVendita_Vendite">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
        ...
        ?>
            <div class="container divMessaggio" id="divAggiornaMatricola_Vendite">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
                    <strong>Attenzione! </strong> Devi inserire la matricola dell'agente di vendita.
                </div>
            </div>
        ...
        ?>
            <div class="container divMessaggio" id="divAggiornaIDCapo_Vendite">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
        ...
        ?>
            <div class="container divMessaggio" id="divAggiornaDataVendita_Vendite">
                <!-- "d-flex justify-content-center" -->
                <div class="alert alert-warning alert-dismissible">
                    <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>  -->
        ...
        if (($ID_Vendite != null) && ($PrezzoVendita != null) && ($Matricola != null) && ($IdCapo != null) && ($DataVendita != null)) {   // Comando SQL  !! Per le stringhe devo usare gli apici !!
            ...
            ?>
                <div class="container divMessaggio">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <strong>Vendita aggiornata correttamente</strong>
                    </div>
                </div>
            ...
            ?>
                <div class="container divMessaggio">
                    ...
                    <div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <strong>Errore nell'aggiornamento della vendita</strong>
                    </div>
                </div>
                <!-- <p class=text-danger></p> -->
        <?php
    ...
    ?>
        <div class="container divMessaggio">
            ...
            <div class="alert alert-warning alert-dismissible">
                ...
                <strong>Attenzione!</strong> Compila tutti i campi.
                <br>
                <strong>Ricorda: </strong>Devi prima aver inserito almeno un dipendente ed un capo d'abbigliamento.
            </div>
        </div>
