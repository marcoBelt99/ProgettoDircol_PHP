    ...
    <div class="row">
        <div class="col-md-6" class="paddingColonneGestioneUtenti">
            ...
            ?>
                ...
                // INSERIMENTO
                if ($U != null && (strcmp($U->Username, '') != 0) && (strcmp($U->Nome, '') != 0)  && (strcmp($U->Cognome, '') != 0) && (strcmp($U->Commento, '') != 0) && ($U->Voto != 0)) { // Se l'oggetto $U non è null
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>#formAggiornaUtenti" name="formAggiornaUtente" class="formOperazioniDML">
                        <div class="form-group">
                            ...
                            <p>
                                ...
                                <input type="text" name="AggiornaNomeUtente" id="AggiornaNomeUtente" onchange="hideDiv('divInserisciNome_Utenti',this); showDiv('divInserisciNome_Utenti',this)">
                            </p>

                            <p>
                                <!-- Cognome -->
                                <label for="CognomeUtente">Cognome dell'utente da aggiornare</label>
                                <input type="text" name="AggiornaCognomeUtente" id="AggiornaCognomeUtente" onchange="hideDiv('divInserisciCognome_Utenti',this); showDiv('divInserisciCognome_Utenti',this)">
                            </p>
                            ...
                            <p>
                                <textarea name="AggiornaCommentoUtente" id="AggiornaCommentoUtente" onchange="hideDiv('divInserisciCommento_Utenti',this); showDiv('divInserisciCommento_Utenti',this)"></textarea>
                            </p>

                            <p>
                                <!-- Voto -->
                                <label for="VotoUtente">Voto dell'utente da aggiornare</label>
                                <input type="number" name="AggiornaVotoUtente" id="AggiornaVotoUtente" min="1" max="5" onchange="hideDiv('divInserisciVoto_Utenti',this); showDiv('divInserisciVoto_Utenti',this)">
                            </p>
        ...
        ?>
            ...
            //AGGIORNAMENTO
            if (($okUsername == true) && ($okNome == true) && ($okCognome == true) && ($okCommento == true) && ($okVoto == true)) {
